...
export const caseList = [
  {
    ...
    desc: '这是一份来自日本的真实抗癌记录。在治疗的至暗时刻，这位患者曾因主治医生的严谨要求，被迫暂停了他一直信赖的免疫支持——CP-101 蘑菇精。然而，当身体经历化疗风暴后，一份医院出具的“病情稳定”报告和医生的“特赦令”，让这股神奇的力量重回体内。随后发生的免疫力“V型反转”，连严谨的医生都感到欣慰……',
    type: 'cp101_mushroom',
    subType: 'lymphoma',
    link: '/case/detail?id=15'
  },
  {
    img: '/case/case-1.png',
    date: '2025-09-24',
    title: '“我以为声音会永远失去”——日本恶性淋巴瘤患者坚持免疫干预后的生活逆转与科学启示',
    desc: '62 岁的佐藤一郎（化名）是当地社区合唱团的骨干成员，嗓音洪亮，是朋友们眼中的“灵魂人物”。',
    type: 'cp101_mushroom',
    subType: 'lymphoma',
