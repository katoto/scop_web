export const products = [
  ...
  },
  {
    ...
    name: "CP-101 キノコエキス",
    subName: "免疫調節・がんサポート",
    description: "ノーベル賞受賞のPD-1免疫メカニズム研究に基づき、三重大学と共同開発。特許取得のアガリクス抽出技術（特許番号：7141630）を採用し、免疫チェックポイントを調節、抗腫瘍治療をサポート、免疫力を向上。",
  ...
  {
    id: 3,
    name: "CP-101 キノコエキス スーパー",
    subName: "がんサポート強化版",
    description: "有効成分濃度を強化し、オリジナルCP-101を超える免疫調節とがんサポート機能を実現。免疫力低下や術後回復期の方に適しています。FDA認証取得、135以上の世界的な研究成果で裏付け。",
  ...
  },
  {
    ...
    name: "CP-101 肝臓サポート",
    subName: "肝機能修復栄養",
    description: "肝細胞の修復と解毒力を強化。飲酒、夜更かし、肝機能低下の方に適しています。抗酸化とDNA修復メカニズムを実験で実証。GMPとISO認証工場で製造、天然成分のトレーサビリティを確保。",
