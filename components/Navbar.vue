                ...
                <div class="mobile-menu-content">
                    <div v-for="(item, menuIndex) in menu" :key="item.name" class="mobile-menu-item">
                        <template v-if="!item.children">
                            <NuxtLink class="mobile-nav-link" :to="localePath(item.path)" @click="closeMobileMenu">
                                {{ $t(item.name) }}
                            </NuxtLink>
                        </template>
                        <template v-else>
                            <div class="mobile-submenu">
                                ...
                                <div class="mobile-submenu-items">
                                    <NuxtLink v-for="child in item.children" :key="child.name" class="mobile-nav-link"
                                        :to="localePath(child.path)" @click="closeMobileMenu">
                                        {{ $t(child.name) }}
                                    </NuxtLink>
                                </div>
                            </div>
                    ...
                    <div class="mobile-language-switcher">
                        <div v-for="locale in availableLocales" :key="locale.code" class="mobile-locale-item">
                            <NuxtLink class="mobile-nav-link" :to="switchLocalePath(locale.code)"
